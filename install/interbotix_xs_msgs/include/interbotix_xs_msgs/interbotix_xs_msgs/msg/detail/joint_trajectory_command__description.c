  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x39, 0x17, 0x12, 0xd5, 0x0b, 0xf3, 0x1f, 0x09,
      0xdd, 0x94, 0x53, 0xb7, 0x46, 0x05, 0x26, 0xe4,
      0x4b, 0x44, 0xf3, 0x8d, 0xab, 0xa5, 0xe7, 0x43,
      0xee, 0xc3, 0x98, 0x0b, 0xcd, 0x19, 0xd3, 0xe2,
    }};
  return &hash;
}
...
static char interbotix_xs_msgs__msg__JointTrajectoryCommand__TYPE_NAME[] = "interbotix_xs_msgs/msg/JointTrajectoryCommand";
...
static char interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__cmd_type[] = "cmd_type";
static char interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__name[] = "name";
static char interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__traj[] = "traj";

static rosidl_runtime_c__type_description__Field interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELDS[] = {
  {
    {interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__cmd_type, 8, 8},
    {
  ...
  {
    {interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__name, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELD_NAME__traj, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription interbotix_xs_msgs__msg__JointTrajectoryCommand__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {interbotix_xs_msgs__msg__JointTrajectoryCommand__TYPE_NAME, 45, 45},
      {interbotix_xs_msgs__msg__JointTrajectoryCommand__FIELDS, 3, 3},
    },
    {interbotix_xs_msgs__msg__JointTrajectoryCommand__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
...
interbotix_xs_msgs__msg__JointTrajectoryCommand__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {interbotix_xs_msgs__msg__JointTrajectoryCommand__TYPE_NAME, 45, 45},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 590, 590},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *interbotix_xs_msgs__msg__JointTrajectoryCommand__get_individual_type_description_source(NULL),
